# Autogenerated wrapper script for AzStorage_jll for x86_64-apple-darwin14
export libAzStorage
...
const libAzStorage_splitpath = ["lib", "libAzStorage.dylib"]
...
const libAzStorage = "@rpath/libAzStorage.so"
