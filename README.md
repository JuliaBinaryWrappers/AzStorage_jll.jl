# `AzStorage_jll.jl` (v0.9.1+0)

[![deps](https://juliahub.com/docs/AzStorage_jll/deps.svg)](https://juliahub.com/ui/Packages/General/AzStorage_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/934d83722e4563b0de473fad56fed7ab3fc10db3/A/AzStorage/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/ChevronETC/AzStorage.jl.git (revision: `f0783fbb41980d4183e6a4042e2a4f9ca40bfdb2`)
